    ...
    a.extend(e.prototype, {
        ...
        setInitialPositions: function () {
            a(this.options.elms).each(function (a, b) {
                var c = b.el.position();
                b.el.hasClass("left") ? ((b.x = c.left), (b.left = !0)) : ((b.x = parseInt(b.el.css("right").replace("px"))), (b.left = !1)),
                    b.el.hasClass("top") ? ((b.y = c.top), (b.top = !0)) : ((b.y = parseInt(b.el.css("bottom").replace("px"))), (b.top = !1));
            });
        },
